...
function library:init()
        ...
        do
            ...
            do
                ...
                objs.sat1 = utility:Draw('Image', {
                    Size = newUDim2(1,0,1,0);
                    Data = crypt.base64decode("");
                    ZIndex = z+3;
    ...
    do
        self.watermark = {
            ...
            text = {
                {"informant.wtf", false},
                {"V"..(getgenv().Config and getgenv().Config.Version or "1.0.0"), true},
                {(getgenv().luaguardvars and getgenv().luaguardvars.DiscordName or "User"), true},
                {'0 fps', true},
                {'0ms', true},
            };
            lock = 'Top';
    ...
    -- Set the initial theme to Gamesense
    for _, v in next, self.themes do
        if v.name == 'Gamesense' then
            self:SetTheme(v.theme)
            break
        end
    end
